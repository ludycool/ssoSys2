...
import com.zhicheng.ssosys.service.RmsDepartmentService;
import com.zhicheng.ssosys.service.RmsRoleService;
import com.zhicheng.ssosys.tool.RandomValidateCodeUtil;
...
public class loginController extends BaseController {
    ...
    public ReSultMode tologin(@RequestParam("loginName") String loginName, @RequestParam("passWrod") String passWrod, @RequestParam("code") String code) {
        ...
        try {
            ...
            adminRole = commonBusinessDao.listWhereVUserRole(wrapper);
